...
#pc
docker tag digit-force-docker.pkg.coding.net/biaopin-swiftagent/ai-project/swift-agent-admin-shuyi:latest swr.cn-southwest-2.myhuaweicloud.com/shushi/swift-agent-admin-shuyi:sxc-prod-202408291621 # 202406181458每次修改更新时间戳就行

# 推送到书亦的镜像仓库

docker push swr.cn-southwest-2.myhuaweicloud.com/shushi/swift-agent-admin-shuyi:sxc-prod-202408291621
